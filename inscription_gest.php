...
//cette page est exactement la même que "inscription.php" à quelques détails près
session_start(); //nécessaire pour maintenir la conneion du gestionnaire (contrairement à inscritpion.php)
...
if (!empty($_POST['nom']) && !empty($_POST['prenom']) && !empty($_POST['telephone']) && !empty($_POST['password'])) {
    ...
    $compte->execute(array(
        ':idMail' => $idMail,
        ':typeC' => 1, //l'inscription de l'élève est directement validée
        ':mot_de_passe' => $lemdp
    ));
    ...
    <div class="container">
        ...
        <?php if (isset($valide)) { ?>
            ...
            <div class="alert alert-info">
                <strong>Important :</strong> Le login est <strong><?= $idMail ?></strong>
            </div>
        <?php } ?>
        ...
        <div class="container">
            <div class="row text-black">
                <div class="col-xl-5 col-lg-6 col-md-8 col-sm-10 mx-auto form p-4">
                    <form class="form-signin form-horizontal" role="form" action="inscription_gest.php" method="POST">
                        <div class="form-group text-center">
                            <label for="nom" style="padding-bottom:5px;">Nom :</label>
                            <input type="text" name="nom" class="form-control mb-2" placeholder="Entrez le nom" required autofocus>
                        </div>
                        ...
                        <div class="form-group text-center">
                            ...
                            <input type="email" name="mail" class="form-control mb-2" placeholder="Entrez le mail" required>
                        </div>

                        <div class="form-group text-center">
                            <label for="telephone" style="padding-bottom:5px;">Téléphone : </label>
                            <input type="tel" pattern="[0-9]{10}" name="telephone" class="form-control mb-2" placeholder="Entrez le téléphone" required>
                        </div>

                        <div class="form-group text-center">
                            <label for="ville" style="padding-bottom:5px;">Ville: </label>
                            <input type="text" name="ville" class="form-control mb-2" placeholder="Entrez la ville de résidence " required>
                        </div>
                        ...
                        <div class="form-group text-center">
                            ...
                            <input type="number" min="2007" max="2023" name="promotion" class="form-control mb-2" placeholder="Entrez la promotion" required>
                        </div>

                        <div class="form-group text-center">
                            <label for="password" style="padding-bottom:5px;">Mot de passe : </label>
                            <input type="password" name="password" class="form-control mb-2" placeholder="Entrez le mot de passe" required>
                        </div><br />
